...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 14-01-2026 a las 00:37:15
...
--
-- Base de datos: `comunidad_ifts_MAPA`
--

-- --------------------------------------------------------

--USE `comunidad_ifts_MAPA`;
...
(8, 'Tecnicatura Superior en Administración de Empresas'),
(3, 'Tecnicatura Superior en Administración Pública'),
(1, 'Tecnicatura Superior en Análisis de Sistemas'),
(2, 'Tecnicatura Superior en Ciencia de Datos e Inteligencia Artificial'),
(10, 'Tecnicatura Superior en Gestión de Políticas Culturales'),
(4, 'Tecnicatura Superior en Gestión Parlamentaria'),
(6, 'Tecnicatura Superior en Hoteleria'),
(9, 'Tecnicatura Superior en Realización Audiovisual'),
(5, 'Tecnicatura Superior en Recursos Humanos'),
(7, 'Tecnicatura Superior en Turismo');
...
INSERT INTO `instituciones_carreras` (`institucion_id`, `carrera_id`) VALUES
(1, 1),
(1, 2),
(1, 3),
(1, 4),
...
ALTER TABLE `instituciones_carreras`
  ADD PRIMARY KEY (`institucion_id`,`carrera_id`),
...
--
ALTER TABLE `instituciones_carreras`
  ADD CONSTRAINT `instituciones_carreras_ibfk_1` FOREIGN KEY (`institucion_id`) REFERENCES `instituciones` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `instituciones_carreras_ibfk_2` FOREIGN KEY (`carrera_id`) REFERENCES `carreras` (`id`) ON DELETE CASCADE;
COMMIT;
